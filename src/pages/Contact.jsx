...
const Contact = () => {
  ...
  const handleOnFocus = () => {setCurrentAnimation('walk')}; //when the input field is active

  const handleOnBlur = () => {setCurrentAnimation('idle')}; //when the field is out of focus
